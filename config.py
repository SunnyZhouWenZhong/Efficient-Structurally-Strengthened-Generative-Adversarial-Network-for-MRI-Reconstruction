...
config.TRAIN.g_beta = 100  # weight for ms-ssim loss
config.TRAIN.g_gamma = 100  # weight for TV loss
...
config.TRAIN.training_data_path = os.path.join('/data/Dataset/MICCAI13_dataset', 'training.pickle')
config.TRAIN.val_data_path = os.path.join('/data/Dataset/MICCAI13_dataset', 'validation.pickle')
config.TRAIN.testing_data_path = os.path.join('/data/Dataset/MICCAI13_dataset', 'testing.pickle')

...
def main_train():
	...
	net_test_sample = generator(t_image_bad_samples, is_train=False, reuse=True)
	...
	for epoch in range(0, n_epoch):
		...
		for step in range(n_step_epoch):
			...
			errG, errG_MAE, errG_msssim, errG_grad, _ = sess.run([g_loss, g_MAE, g_ms_ssim, g_grad, g_optim],
		...
		if esn == 0:
			...
			x_gen_0_1 = (x_gen + 1) / 2
			savemat(save_dir + '/test_random_{}_generated.mat'.format(sample_size), {'x_gen_0_1': x_gen_0_1})
